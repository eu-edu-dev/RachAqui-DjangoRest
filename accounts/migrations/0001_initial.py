    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('COSTUMER', 'Costumer'), ('RESTAURANT', 'Restaurant')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costumer', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.person')),
                ('restaurant', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.company')),
